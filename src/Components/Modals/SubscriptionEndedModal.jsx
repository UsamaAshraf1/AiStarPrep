...
function SubscriptionEndedModal({ onClose }) {
  return (
    <div>
      <button
        onClick={() => onClose()}
      ...
      <div className="flex gap-6">
        ...
        <div className="flex-1 space-y-2">
          ...
          <p className="text-[#707070]">
            Your subscription has ended on 23 jan 2025. You can no longer access
            premium features and content. But don't worry, your progress and
            data are safe, and you can renew your subscription at any time to
